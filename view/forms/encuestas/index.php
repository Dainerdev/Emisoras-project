...
<body>
    <div class="container">
        ...
        <div class="options">
            ...
            <div id="Buscar">
                <a href="../../../view/forms/encuestas/buscar.php">
                    <img id="search" src="../../img/search.png">
                    <p id="search">Buscar, edita o elimina</p>
                </a>
            </div>
            <div id="Listar">
                <a href="../../../controllers/EncuestaController.php?accion=todo">
                    <img id="list" src="../../img/list.png">
                    <p id="list">Listar</p></a>
            </div>
        </div>        
    </div>
</body>
